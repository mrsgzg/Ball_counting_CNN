...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        print()
        print("新特性 - 同时提供2D和3D可视化:")
        print("  • 主图中始终显示2D PCA轨迹")
        print("  • 独立生成3D PCA轨迹图")
        print("  • 完整的3D轨迹总结图")
        print("  • 多角度2D投影图")
        print()
        ...
        print("  • Softmax输出分布")
        print("  • LSTM隐状态演化 (2D主图 + 3D补充)")
        print("  • 预测序列对比")
        print()
        print("使用方法:")
        print("python Universal_LSTM_Viz_Modified.py --checkpoint MODEL.pth --val_csv VAL.csv")
        print()
        print("示例:")
        print("# 可视化原始Embodiment模型")
        print("python Universal_LSTM_Viz_Modified.py \\")
        ...
        print("💡 输出文件说明:")
        print("  每个样本文件夹包含:")
        print("  • frame_XXX.png - 主可视化图 (2D LSTM)")
        print("  • lstm_3d_frame_XXX.png - 3D LSTM轨迹")
        print("  • lstm_3d_summary.png - 完整3D轨迹分析")
        print("  • summary.png - 汇总图")
        print("  • data.json - 数值数据")
        sys.exit(0)

...
--image_mode 'rgb' \
--scheduler_type 'none' \
--save_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Count_only/100data/check_points \
--log_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Count_only/100data/logs \
--save_every 2 \
--num_workers 4

...
--image_mode 'rgb' \
--scheduler_type 'none' \
--save_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Visual_only/10data/check_points \
--log_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Visual_only/10data/logs \
--save_every 2 \
--num_workers 4

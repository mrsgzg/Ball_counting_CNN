...
--stage_1_epochs 0 \
--stage_2_epochs 350 \
--save_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Full/100data/check_points \
--log_dir ./scratch/Ball_counting_CNN/Final_result/Embodiment_Full/100data/logs \
--save_every 2 \
--scheduler_type 'none' \
--attention_heads 1 \
--learning_rate 1e-4 \
